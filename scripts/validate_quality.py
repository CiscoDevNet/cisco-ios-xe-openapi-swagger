...
class QualityValidator:
    ...
    def run_validation(self):
        ...
        categories = [
            ...
            ('Operational v2', 'swagger-oper-model/api'),
            ('RPC', 'swagger-rpc-model/api'),
            ('Config', 'swagger-cfg-model/api'),
            ('Config v2', 'swagger-cfg-model/api'),
            ('OpenConfig', 'swagger-openconfig-model/api'),
            ('OpenConfig v2', 'swagger-openconfig-model/api'),
            ('Native', 'swagger-native-config-model/api'),
            ('Native v2', 'swagger-native-config-model/api'),
